	...
	private Component createToolBar() {
		...
		add.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO 添加好友
				OSUtils.Browser.open("web.qq.com");
			}
		});
		mail.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO QQ邮箱
				OSUtils.Browser.open("mail.qq.com");
			}
		});
		qzone.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO QQ空间
				OSUtils.Browser.open("qzone.qq.com");
			}
		});
		...
		msg.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO 处理消息
				OSUtils.Browser.open("id.qq.com");
			}
		});
